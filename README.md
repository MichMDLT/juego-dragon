#Un sencillo pero emocionante juego de texto, donde tomarás decisiones sabias para sobrevivir.

##🎮 Cómo jugar
Rol: eres un aventurero que quedó atrapado en una mazmorra con tres puertas misteriosas. ¡Encuentra la salida! O encuentra al dragón (lo que pase primero).
...
Copy
Edit
git clone https://github.com/TU-USUARIO/aventura-mazmorra.git
